	...
	<div class="iq-navbar-custom">
		...
		<nav class="p-0 navbar navbar-expand-lg navbar-light">
			...
			<ul class="navbar-list">
				<li>
					<a href="#" class="text-white search-toggle iq-waves-effect bg-primary"><img src="{{ asset('assets/images/logo.png') }}" class="rounded img-fluid" alt="admin"></a>
							...
							<div class="p-0 iq-card-body ">
								<div class="p-3 text-center d-inline-block w-100">
									<form method="POST" action="{{ route('admin.logout') }}">
										@csrf
										<a class="iq-bg-danger iq-sign-btn" href="{{ route('admin.logout') }}" onclick="event.preventDefault(); this.closest('form').submit();" role="button">
											Sign out
